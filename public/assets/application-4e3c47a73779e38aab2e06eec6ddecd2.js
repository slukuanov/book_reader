...
/*!
 * Generated using the Bootstrap Customizer (http://getbootstrap.com/customize/?id=5463edd922c70eb3315b)
 * Config saved to config.json and https://gist.github.com/5463edd922c70eb3315b
 */
...
(function() {
  ...
  admin = {
    ...
    selectChapter: function() {
      return $(document).on('click', '#book-content .chapters-list li a.chapter', function(e) {
        e.preventDefault();
...
(function() {
  $(function() {
    return $(document).on('submit', '#registration-via-email-modal form, #login-modal form', function(e) {
      var that;
      e.preventDefault();
      $('html, body').css("cursor", "wait");
      that = $(this);
      ...
      return $.ajax({
        ...
        error: function(data, textStatus, jqXHR) {
          $('html, body').css("cursor", "auto");
          return $.each(JSON.parse(data.responseText), function(value) {
            return that.find(".input.user_" + value).addClass('error_valid');
          });
        }
      });
    });
